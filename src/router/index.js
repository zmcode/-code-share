...
const routes = [
  ...
  },
  {
    ...
    redirect: "/html/settings/profile",
    meta: { requireAuth: true },
    children: [
      {
        path: "profile",
  ...
  {
    path: "/html/work/:username/:instanceID",
    name: "Work",
    component: () => import("@views/instance"),
    meta: { hideHAF: true },
  },
...
router.beforeEach(async (to, _, next) => {
  ...
  //         const giteeRes = await api.loginGitee(
  //           { code },
  //           authT ? { headers: { token: authT } } : {}
  //         );
  ...
  //           if (bindState) {
  //             const oauthLoginRes = await api.oauthLogin(
  //               {},
