...
const iframeLinks = {
  ...
  commonJS: ["//img.yjdzm.com/js/JSEController.js"],
};

const formatLinks = {
  typeScript:
    "https://cdn.staticfile.org/prettier/2.5.1/parser-typescript.min.js",
};

export { externalLinks, iframeLinks, formatLinks };
